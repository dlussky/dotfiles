...
sudo apt-get -yV install chromium-browser redshift-gtk qbittorrent skype keepass2 virtualbox autossh compton mc guake albert php php-cli php-xml doublecmd-gtk sublime-text filezilla cabextract moc zsh tmux htop build-essential checkinstall openssh-server expect screenfetch numix-icon-theme
