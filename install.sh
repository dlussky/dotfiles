...
sudo apt-get -yV install compton mc guake albert php php-cli doublecmd-gtk sublime-text filezilla cabextract moc zsh tmux htop build-essential checkinstall openssh-server expect screenfetch numix-icon-theme
